    ...
    <div className="flex flex-col gap-6 lg:flex-row">
        ...
        <div className="flex flex-wrap items-center gap-2 text-sm font-medium text-slate-600">
          ...
          <button
            onClick={handleSave}
            disabled={isSaving}
            className="absolute right-28 top-4 z-10 rounded-full bg-teal-500 px-5 py-2 text-sm font-semibold text-white shadow hover:bg-teal-600 transition disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
          >
            {isSaving ? (
              <>
            ...
            <div className="rounded-2xl border border-slate-200 p-4 space-y-3">
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  const updatedText = texts.find((t) => t.id === selectedTextId);
                  setTexts((prev) =>
                    prev.map((text) =>
